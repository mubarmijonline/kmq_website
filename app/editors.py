...
COPY_GROUPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("Branches", ('branches_title', 'branch_page_title', 'all_branches_link', 'hours_label', 'branch_wa', 'directions', 'map_shot', 'pickup_title', 'pickup_cta', 'branch_shot')),
    ...
    ("FAQ", ('faq_title',)),
    ("Blog", ('blog_title', 'blog_page_title', 'blog_page_sub', 'all_blog_link', 'featured', 'search_placeholder', 'all_cats', 'results_one', 'results_many', 'no_results', 'popular', 'by_category', 'tags_title', 'news_title', 'news_body', 'news_placeholder', 'news_cta', 'blog_aside_cta', 'prev', 'next', 'min_read', 'article_cta', 'article_pending', 'back_to_blog')),
...
#: Shown under every icon field. The names are the client's kit, as
#: scripts/build_icons.py emits it; nothing else renders.
ICON_HINT = "A name from the client's icon set: " + ", ".join(sorted(C.ICONS))
